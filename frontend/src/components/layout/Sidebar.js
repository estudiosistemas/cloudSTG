...
const Sidebar = () => {
  ...
  if (!isAuthenticated) return <h1>Debe autenticarse</h1>;

  return (
    <aside className="main-sidebar sidebar-dark-primary elevation-4">
      {/* Brand Logo */}
      <Link to="/stg" className="brand-link">
        {/* <img
          ...
          style={{ opacity: ".8" }}
        /> */}
        <span className="brand-text font-weight-light">CloudSTG</span>
      </Link>
      {/* Sidebar */}
      <div className="sidebar">
        ...
        <div className="user-panel mt-3 pb-3 mb-3 d-flex">
          <div className="image">
            <img
              src="../../static/frontend/dist/img/user2-160x160.jpg"
